...
//     .pipe(gulp.dest("src/assets/vendors/jquery-bar-rating"));
    ...
    const aStyle9 = gulp.src(['./node_modules/@mdi/font/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/mdi'));
    const aStyle10 = gulp.src(['./node_modules/puse-icons-feather/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/puse-icons-feather'));
    const aStyle11 = gulp.src(['./node_modules/font-awesome/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/font-awesome'));
    const aStyle12 = gulp.src(['./node_modules/flag-icon-css/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/flag-icon-css'));

    const aStyle13 = gulp.src(['./node_modules/@mdi/font/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/mdi'));
    const aStyle14 = gulp.src(['./node_modules/puse-icons-feather/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/puse-icons-feather'));
    const aStyle15 = gulp.src(['./node_modules/font-awesome/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/font-awesome'));
    const aStyle16 = gulp.src(['./node_modules/flag-icon-css/**/*'])
        .pipe(gulp.dest('src/assets/vendors/iconfonts/flag-icon-css'));

    const aStyle17 = gulp.src(['./node_modules/ionicons/**/*'])
